...
# Modified by author
# Added Knowledge accumulation module
# --------------------------------------------------------
...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, mask: Optional[torch.Tensor] = None, attn_res: Optional[torch.Tensor] = None, batch=None):
        """
        Args:
...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self, x, attn_res):
        ...
        # W-MSA/SW-MSA
        # attn_windows, attn_res = self.attn(x_windows, mask=self.attn_mask, attn_res=attn_res)  # num_win*B, window_size*window_size, C
        attn_windows, attn_res = self.attn(x_windows, mask=self.attn_mask, attn_res=attn_res, batch=B)  # num_win*B, window_size*window_size, C (passing also the batch size)
...
class SwinTransformer(nn.Module):
    ...
    def forward(self, x):
        attn_res = None
        x, attn_res = self.forward_features(x, attn_res)
